...
class ColorPallete(globalInfo: GlobalInfo, rendererState: RendererState) :
...
uniform float iPaletteWidth;
uniform float iPalleteRadius

uniform mat4 myColor1;
uniform mat4 myColor2;
uniform mat4 myColor3;
...
void main() {
    ...
    float innerRadius = iPaletteRadius / iResolution.y;
    float paletteWidth = iWheelWidth / iResolution.y;
    float outerRadius = innerRadius + paletteWidth;
